+!~-(function(PIXI, window, document, undefined) {
  ...
  function reset() {
    w = Math.max(document.getElementById('surface').scrollWidth, document.getElementById('surface').offsetWidth, document.getElementById('surface').clientWidth, document.getElementById('surface').scrollWidth, document.getElementById('surface').offsetWidth);
